...
public interface NativeType
    ...
    java.lang.String getAliasedType();

    // <editor-fold defaultstate="collapsed" desc="Builder support">
    public static NativeTypeBuilder builder() {
        return new schemarise.alfa.runtime.model.NativeType._NativeTypeBuilderImpl();
    }

    public static NativeTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            return bc.getCustomBuilderFactory()
                    .get()
                    .builder(
                            bc,
                            schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.INSTANCE);
        else return new schemarise.alfa.runtime.model.NativeType._NativeTypeBuilderImpl(bc);
    }
    ...
    public interface NativeTypeBuilder
        ...
        NativeTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v);

        NativeTypeBuilder setExtendedAttribs(java.util.Map<java.lang.String, java.lang.String> v);

        java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> getExtendedAttribs();

        NativeTypeBuilder setAnnotations(
                java.util.Optional<
                                java.util.Map<
                                        java.lang.String,
                                        java.util.Map<
        ...
        NativeTypeBuilder setDoc(java.util.Optional<java.lang.String> v);

        NativeTypeBuilder setDoc(java.lang.String v);

        java.util.Optional<java.lang.String> getDoc();

        NativeTypeBuilder setName(schemarise.alfa.runtime.model.UdtVersionedName v);

        schemarise.alfa.runtime.model.UdtVersionedName getName();

        NativeTypeBuilder setChecksum(java.lang.String v);

        java.lang.String getChecksum();

        NativeTypeBuilder addModifiers(schemarise.alfa.runtime.model.ModifierType e);

        NativeTypeBuilder addAllModifiers(
                java.util.Set<schemarise.alfa.runtime.model.ModifierType> all);

        java.util.Set<schemarise.alfa.runtime.model.ModifierType> getModifiers();

        NativeTypeBuilder setSource(schemarise.alfa.runtime.model.Union__ModelBaseNode__Source v);

        schemarise.alfa.runtime.model.Union__ModelBaseNode__Source getSource();

        NativeTypeBuilder setReferencedInFieldTypeFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v);
        ...
        NativeTypeBuilder setIncludes(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v);

        NativeTypeBuilder setIncludes(java.util.List<schemarise.alfa.runtime.model.UdtDataType> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> getIncludes();

        NativeTypeBuilder setScope(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v);

        NativeTypeBuilder setScope(java.util.List<schemarise.alfa.runtime.model.UdtDataType> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> getScope();

        NativeTypeBuilder setIncludedFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v);
        ...
        NativeTypeBuilder setModelId(java.util.Optional<java.lang.String> v);

        NativeTypeBuilder setModelId(java.lang.String v);

        java.util.Optional<java.lang.String> getModelId();

        NativeTypeBuilder putAllFields(java.lang.String k, schemarise.alfa.runtime.model.Field v);

        NativeTypeBuilder putAllAllFields(
                java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> all);

        java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> getAllFields();

        NativeTypeBuilder setExtends(
                java.util.Optional<schemarise.alfa.runtime.model.UdtDataType> v);

        NativeTypeBuilder setExtends(schemarise.alfa.runtime.model.UdtDataType v);

        java.util.Optional<schemarise.alfa.runtime.model.UdtDataType> getExtends();

        NativeTypeBuilder addLocalFieldNames(java.lang.String e);

        NativeTypeBuilder addAllLocalFieldNames(java.util.List<java.lang.String> all);

        java.util.List<java.lang.String> getLocalFieldNames();

        NativeTypeBuilder setInheritedFields(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.InheritedFields>>
                        v);
        ...
        NativeTypeBuilder setIsSynthetic(boolean v);

        boolean getIsSynthetic();

        NativeTypeBuilder setAsserts(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Assert>> v);

        NativeTypeBuilder setAsserts(java.util.List<schemarise.alfa.runtime.model.Assert> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Assert>> getAsserts();

        NativeTypeBuilder setLinkages(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Linkage>> v);

        NativeTypeBuilder setLinkages(java.util.List<schemarise.alfa.runtime.model.Linkage> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Linkage>> getLinkages();

        NativeTypeBuilder setAliasedType(java.lang.String v);
    ...
    final class _NativeTypeBuilderImpl extends _NativeType__Base__ implements NativeTypeBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _NativeTypeBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _NativeTypeBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.INSTANCE;
        }

        public NativeTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExtendedAttribs", v);
            this._extendedAttribs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor
        ...
        public NativeTypeBuilder setAnnotations(
                java.util.Optional<
                                java.util.Map<
                                        java.lang.String,
                                        java.util.Map<
        ...
        public NativeTypeBuilder setDoc(java.util.Optional<java.lang.String> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Doc", v);
            this._doc = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_DOC);
            return this;
        }

        public NativeTypeBuilder setDoc(java.lang.String v) {
        ...
        public NativeTypeBuilder setName(schemarise.alfa.runtime.model.UdtVersionedName v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Name", v);
            this._name = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_NAME);
            return this;
        }

        public NativeTypeBuilder setChecksum(java.lang.String v) {
        ...
        public NativeTypeBuilder addModifiers(schemarise.alfa.runtime.model.ModifierType e) {
        ...
        public NativeTypeBuilder addAllModifiers(
                java.util.Set<schemarise.alfa.runtime.model.ModifierType> all) {
        ...
        private NativeTypeBuilder setModifiers(
                java.util.Set<schemarise.alfa.runtime.model.ModifierType> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Modifiers", all);
            this._modifiers = all;
            clearMissingFlag(
        ...
        public NativeTypeBuilder setSource(
                schemarise.alfa.runtime.model.Union__ModelBaseNode__Source v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Source", v);
            this._source = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_SOURCE);
            return this;
        }

        public NativeTypeBuilder setReferencedInFieldTypeFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v) {
        ...
        public NativeTypeBuilder setIncludes(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v) {
        ...
        public NativeTypeBuilder setScope(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Scope", v);
            this._scope = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_SCOPE);
            return this;
        }
        ...
        public NativeTypeBuilder setIncludedFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v) {
        ...
        public NativeTypeBuilder setModelId(java.util.Optional<java.lang.String> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ModelId", v);
            this._modelId = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_MODELID);
            return this;
        }

        public NativeTypeBuilder setModelId(java.lang.String v) {
        ...
        public NativeTypeBuilder putAllFields(
        ...
        public NativeTypeBuilder putAllAllFields(
                java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> all) {
        ...
        private NativeTypeBuilder setAllFields(
                java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("AllFields", all);
            _allFields = all;
            clearMissingFlag(
        ...
        public NativeTypeBuilder setExtends(
                java.util.Optional<schemarise.alfa.runtime.model.UdtDataType> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Extends", v);
            this._extends = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_EXTENDS);
            return this;
        }

        public NativeTypeBuilder setExtends(schemarise.alfa.runtime.model.UdtDataType v) {
        ...
        public NativeTypeBuilder addLocalFieldNames(java.lang.String e) {
        ...
        public NativeTypeBuilder setLocalFieldNames(int index, java.lang.String e) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("LocalFieldNames", e);
            if (this._localFieldNames == null) createLocalFieldNames();
        ...
        public NativeTypeBuilder addAllLocalFieldNames(java.util.List<java.lang.String> all) {
        ...
        private NativeTypeBuilder setLocalFieldNames(java.util.List<java.lang.String> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("LocalFieldNames", all);
        ...
        public NativeTypeBuilder setInheritedFields(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.InheritedFields>>
                        v) {
        ...
        public NativeTypeBuilder setIsSynthetic(boolean v) {
        ...
        public NativeTypeBuilder setAsserts(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Assert>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Asserts", v);
            this._asserts = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor.FIELD_ID_ASSERTS);
            return this;
        }
        ...
        public NativeTypeBuilder setLinkages(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Linkage>> v) {
        ...
        public NativeTypeBuilder setAliasedType(java.lang.String v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("AliasedType", v);
            this._aliasedType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor
                            .FIELD_ID_ALIASEDTYPE);
            return this;
        }
        ...
        public void modify(java.lang.String fieldName, java.lang.Object val) {
            switch (fieldName) {
                ...
                case "Linkages":
                    ...
                    break;
                case "AliasedType":
                    setAliasedType((java.lang.String) val);
                    break;
                default:
        ...
        public NativeType build() {
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                ...
                obj =
                        new schemarise.alfa.runtime.model.NativeType._NativeTypeConcrete(
                                _extendedAttribs,
                                _annotations,
                                _doc,
                                _name,
                                ...
                                com.schemarise.alfa.runtime.utils.VectorCloner.immutableSet(
                                        builderConfig(),
                                        schemarise.alfa.runtime.model.NativeType
                                                .NativeTypeDescriptor.INSTANCE
                                                ._modifiersSupplierInner1,
                                        _modifiers),
                                _source,
                                _referencedInFieldTypeFrom,
    ...
    final class _NativeTypeConcrete extends _NativeType__Base__ implements NativeType {

        private _NativeTypeConcrete() {
            super();
        }
    ...
    abstract class _NativeType__Base__ {
        ...
        public java.lang.String _aliasedType;

        public _NativeType__Base__() {}
        ...
        public _NativeType__Base__(
            ...
            this._aliasedType = _aliasedType;
        }
        ...
        public java.lang.String getAliasedType() {
            return _aliasedType;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof schemarise.alfa.runtime.model.NativeType._NativeTypeConcrete))
                return false;
            schemarise.alfa.runtime.model.NativeType._NativeTypeConcrete rhs =
                    (schemarise.alfa.runtime.model.NativeType._NativeTypeConcrete) o;
            return java.util.Objects.equals(_extendedAttribs, rhs._extendedAttribs)
                    ...
                    && java.util.Objects.equals(_aliasedType, rhs._aliasedType);
        }
    ...
    public static final class NativeTypeDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME = "schemarise.alfa.runtime.model.NativeType";
        public static schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor INSTANCE =
                new schemarise.alfa.runtime.model.NativeType.NativeTypeDescriptor();
        ...
        public static final short FIELD_ID_ALIASEDTYPE = 19;
        public static final String FIELD_ALIASEDTYPE = "AliasedType";
        ...
        private schemarise.alfa.runtime.model.ScalarDataType _aliasedTypeType =
                schemarise.alfa.runtime.model.ScalarDataType.builder()
                        .setScalarType(schemarise.alfa.runtime.model.ScalarType.stringType)
                        .build();
        ...
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.NativeType._NativeTypeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
        ...
        /* -- Consumer string -- */
        java.util.function.Function<com.schemarise.alfa.runtime.DataSupplier, java.lang.String>
                _aliasedTypeConsumerInner1 =
                        (supplierInner1) -> {
                            return supplierInner1.stringValue(
                                    ((schemarise.alfa.runtime.model.ScalarDataType) _aliasedTypeType));
                        };
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.NativeType._NativeTypeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
                _aliasedTypeConsumer =
                        (builder, supplier) -> {
                            builder.setAliasedType(_aliasedTypeConsumerInner1.apply(supplier));
                        };
        ...
        private java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.NativeType,
                        com.schemarise.alfa.runtime.DataConsumer>
                _aliasedTypeSupplier =
                        (p, consumer) -> {
                            _aliasedTypeSupplierInner1.accept(p.getAliasedType(), consumer);
                        };

        public java.util.Optional<
                        java.util.function.BiConsumer<
                                NativeType, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        public com.schemarise.alfa.runtime.FieldMeta linkagesMeta =
                new com.schemarise.alfa.runtime.FieldMeta(
                        ...
                        FIELD_LINKAGES,
                        java.util.Optional.empty());
        public com.schemarise.alfa.runtime.FieldMeta aliasedTypeMeta =
                new com.schemarise.alfa.runtime.FieldMeta(
                        java.util.Optional.of(_aliasedTypeSupplier),
                        java.util.Optional.of(_aliasedTypeConsumer),
                        java.util.Optional.of(_aliasedTypeSupplierInner1),
                        java.util.Optional.of(_aliasedTypeConsumerInner1),
                        _aliasedTypeType,
                        FIELD_ALIASEDTYPE,
                        java.util.Optional.empty());
        ...
        @Override
        public NativeTypeBuilder builder() {
            return new schemarise.alfa.runtime.model.NativeType._NativeTypeBuilderImpl();
        }

        @Override
        public NativeTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.NativeType._NativeTypeBuilderImpl(cc);
        }
        ...
        protected java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<NativeType>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
                                        ...
                                        put(FIELD_ALIASEDTYPE, aliasedTypeMeta);
                                    }
                                });
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<NativeType>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
        ...
        public java.lang.String fieldIdName(int id) {
            switch (id) {
                ...
                case FIELD_ID_ALIASEDTYPE:
                    return FIELD_ALIASEDTYPE;
                default:
