...
public interface AnyDataType
    ...
    public static AnyDataTypeBuilder builder() {
        return new schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeBuilderImpl();
    }

    public static AnyDataTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            return bc.getCustomBuilderFactory()
                    .get()
                    .builder(
                            bc,
                            schemarise.alfa.runtime.model.AnyDataType.AnyDataTypeDescriptor
                                    .INSTANCE);
        else return new schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeBuilderImpl(bc);
    }
    ...
    public interface AnyDataTypeBuilder
        ...
        AnyDataTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v);

        AnyDataTypeBuilder setExtendedAttribs(java.util.Map<java.lang.String, java.lang.String> v);

        java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> getExtendedAttribs();

        AnyDataTypeBuilder setTypeDefName(java.util.Optional<java.lang.String> v);

        AnyDataTypeBuilder setTypeDefName(java.lang.String v);
    ...
    final class _AnyDataTypeBuilderImpl extends _AnyDataType__Base__ implements AnyDataTypeBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _AnyDataTypeBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _AnyDataTypeBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.AnyDataType.AnyDataTypeDescriptor.INSTANCE;
        }

        public AnyDataTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v) {
        ...
        public AnyDataTypeBuilder setTypeDefName(java.util.Optional<java.lang.String> v) {
        ...
        public AnyDataTypeBuilder setTypeDefName(java.lang.String v) {
        ...
        public AnyDataType build() {

            com.schemarise.alfa.runtime.utils.Utils.assertMandatoryFieldsSet(
                    builderConfig(),
                    __missingFields,
                    2,
                    schemarise.alfa.runtime.model.AnyDataType.AnyDataTypeDescriptor.INSTANCE);
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                ...
                obj =
                        new schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeConcrete(
    ...
    final class _AnyDataTypeConcrete extends _AnyDataType__Base__ implements AnyDataType {

        private _AnyDataTypeConcrete() {
            super();
        }
    ...
    abstract class _AnyDataType__Base__ {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeConcrete))
                return false;
            schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeConcrete rhs =
                    (schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeConcrete) o;
    ...
    public static final class AnyDataTypeDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME = "schemarise.alfa.runtime.model.AnyDataType";
        public static schemarise.alfa.runtime.model.AnyDataType.AnyDataTypeDescriptor INSTANCE =
                new schemarise.alfa.runtime.model.AnyDataType.AnyDataTypeDescriptor();
        ...
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                AnyDataType, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public AnyDataTypeBuilder builder() {
            return new schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeBuilderImpl();
        }

        @Override
        public AnyDataTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.AnyDataType._AnyDataTypeBuilderImpl(cc);
        }

        public AnyDataTypeDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<AnyDataType>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<AnyDataType>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.AnyDataType{ExtendedAttribs:optional<map<string,string>;>;TypeDefName:optional<string;>;}
            schemarise.alfa.runtime.model.AnyDataType{}
            */
            return "43147c33:4e8a7676";
        }
    }
    // </editor-fold>
