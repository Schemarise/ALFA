...
public interface Expression__NewExpr extends com.schemarise.alfa.runtime.Record {
    ...
    public static Expression__NewExprBuilder builder() {
        return new schemarise.alfa.runtime.model.Expression__NewExpr
                ._Expression__NewExprBuilderImpl();
    }
    ...
    public static Expression__NewExprBuilder builder(
        ...
        if (bc.getCustomBuilderFactory().isPresent())
            ...
            return new schemarise.alfa.runtime.model.Expression__NewExpr
                    ._Expression__NewExprBuilderImpl(bc);
    }
    ...
    public interface Expression__NewExprBuilder
            extends com.schemarise.alfa.runtime.Builder, com.schemarise.alfa.runtime.AlfaObject {
        Expression__NewExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getExprType();

        Expression__NewExprBuilder setUdtName(java.lang.String v);

        java.lang.String getUdtName();

        Expression__NewExprBuilder addArgs(schemarise.alfa.runtime.model.NamedExpression e);

        Expression__NewExprBuilder addAllArgs(
                java.util.List<schemarise.alfa.runtime.model.NamedExpression> all);

        java.util.List<schemarise.alfa.runtime.model.NamedExpression> getArgs();

        Expression__NewExpr build();
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Builder Impl class">
    final class _Expression__NewExprBuilderImpl extends _Expression__NewExpr__Base__
            implements Expression__NewExprBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _Expression__NewExprBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _Expression__NewExprBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Expression__NewExpr.Expression__NewExprDescriptor
                    .INSTANCE;
        }

        public Expression__NewExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExprType", v);
            this._exprType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__NewExpr.Expression__NewExprDescriptor
                            .FIELD_ID_EXPRTYPE);
            return this;
        }

        public Expression__NewExprBuilder setUdtName(java.lang.String v) {
        ...
        public Expression__NewExprBuilder addArgs(schemarise.alfa.runtime.model.NamedExpression e) {
        ...
        public Expression__NewExprBuilder setArgs(
        ...
        public Expression__NewExprBuilder addAllArgs(
                java.util.List<schemarise.alfa.runtime.model.NamedExpression> all) {
        ...
        private Expression__NewExprBuilder setArgs(
                java.util.List<schemarise.alfa.runtime.model.NamedExpression> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Args", all);
            this._args = all;
            clearMissingFlag(
        ...
        public Expression__NewExpr build() {
                                                ...
                                                com.schemarise.alfa.runtime.utils.VectorCloner
                                                        .immutableList(
                                                                ...
                                                                schemarise.alfa.runtime.model
                                                                        .Expression__NewExpr
                                                                        .Expression__NewExprDescriptor
                                                                        .INSTANCE
                                                                        ._argsSupplierInner1,
                                                                _args));
            else
                obj =
                        new schemarise.alfa.runtime.model.Expression__NewExpr
                                ._Expression__NewExprConcrete(
                                _exprType,
                                _udtName,
    ...
    final class _Expression__NewExprConcrete extends _Expression__NewExpr__Base__
            implements Expression__NewExpr {

        private _Expression__NewExprConcrete() {
            super();
        }
    ...
    abstract class _Expression__NewExpr__Base__ {
        ...
        public _Expression__NewExpr__Base__() {}
        ...
        public boolean equals(Object o) {
            ...
            if (!(o
                    instanceof
                    schemarise.alfa.runtime.model.Expression__NewExpr._Expression__NewExprConcrete))
                return false;
            schemarise.alfa.runtime.model.Expression__NewExpr._Expression__NewExprConcrete rhs =
                    (schemarise.alfa.runtime.model.Expression__NewExpr._Expression__NewExprConcrete)
                            o;
    ...
    public static final class Expression__NewExprDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME =
                "schemarise.alfa.runtime.model.Expression__NewExpr";
        public static schemarise.alfa.runtime.model.Expression__NewExpr
                        .Expression__NewExprDescriptor
                INSTANCE =
                        new schemarise.alfa.runtime.model.Expression__NewExpr
                                .Expression__NewExprDescriptor();
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                Expression__NewExpr, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public Expression__NewExprBuilder builder() {
            return new schemarise.alfa.runtime.model.Expression__NewExpr
                    ._Expression__NewExprBuilderImpl();
        }

        @Override
        public Expression__NewExprBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.Expression__NewExpr
                    ._Expression__NewExprBuilderImpl(cc);
        }

        public Expression__NewExprDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<
                        java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Expression__NewExpr>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.Expression__NewExpr{ExprType:schemarise.alfa.runtime.model.IDataType[4404d6a0];args:list<schemarise.alfa.runtime.model.NamedExpression[7e92a8e5]>;udtName:string;}
            schemarise.alfa.runtime.model.Expression__NewExpr{ExprType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];args:list<schemarise.alfa.runtime.model.NamedExpression[7e92a8e5]>;udtName:string;}
            */
            return "26b04127:dc6c6ec4";
        }
    }
    // </editor-fold>
