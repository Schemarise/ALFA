...
public interface Union
    ...
    public static UnionBuilder builder() {
        return new schemarise.alfa.runtime.model.Union._UnionBuilderImpl();
    }

    public static UnionBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            return bc.getCustomBuilderFactory()
                    .get()
                    .builder(bc, schemarise.alfa.runtime.model.Union.UnionDescriptor.INSTANCE);
        else return new schemarise.alfa.runtime.model.Union._UnionBuilderImpl(bc);
    }
    ...
    public interface UnionBuilder
        ...
        UnionBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v);

        UnionBuilder setExtendedAttribs(java.util.Map<java.lang.String, java.lang.String> v);

        java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> getExtendedAttribs();

        UnionBuilder setAnnotations(
                java.util.Optional<
                                java.util.Map<
                                        java.lang.String,
                                        java.util.Map<
        ...
        UnionBuilder setDoc(java.util.Optional<java.lang.String> v);

        UnionBuilder setDoc(java.lang.String v);

        java.util.Optional<java.lang.String> getDoc();

        UnionBuilder setName(schemarise.alfa.runtime.model.UdtVersionedName v);

        schemarise.alfa.runtime.model.UdtVersionedName getName();

        UnionBuilder setChecksum(java.lang.String v);

        java.lang.String getChecksum();

        UnionBuilder addModifiers(schemarise.alfa.runtime.model.ModifierType e);

        UnionBuilder addAllModifiers(java.util.Set<schemarise.alfa.runtime.model.ModifierType> all);

        java.util.Set<schemarise.alfa.runtime.model.ModifierType> getModifiers();

        UnionBuilder setSource(schemarise.alfa.runtime.model.Union__ModelBaseNode__Source v);

        schemarise.alfa.runtime.model.Union__ModelBaseNode__Source getSource();

        UnionBuilder setReferencedInFieldTypeFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v);
        ...
        UnionBuilder setIncludes(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v);

        UnionBuilder setIncludes(java.util.List<schemarise.alfa.runtime.model.UdtDataType> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> getIncludes();

        UnionBuilder setScope(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v);

        UnionBuilder setScope(java.util.List<schemarise.alfa.runtime.model.UdtDataType> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> getScope();

        UnionBuilder setIncludedFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v);
        ...
        UnionBuilder setModelId(java.util.Optional<java.lang.String> v);

        UnionBuilder setModelId(java.lang.String v);

        java.util.Optional<java.lang.String> getModelId();

        UnionBuilder putAllFields(java.lang.String k, schemarise.alfa.runtime.model.Field v);

        UnionBuilder putAllAllFields(
                java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> all);

        java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> getAllFields();

        UnionBuilder setExtends(java.util.Optional<schemarise.alfa.runtime.model.UdtDataType> v);

        UnionBuilder setExtends(schemarise.alfa.runtime.model.UdtDataType v);

        java.util.Optional<schemarise.alfa.runtime.model.UdtDataType> getExtends();

        UnionBuilder addLocalFieldNames(java.lang.String e);

        UnionBuilder addAllLocalFieldNames(java.util.List<java.lang.String> all);

        java.util.List<java.lang.String> getLocalFieldNames();

        UnionBuilder setInheritedFields(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.InheritedFields>>
                        v);
        ...
        UnionBuilder setIsSynthetic(boolean v);

        boolean getIsSynthetic();

        UnionBuilder setAsserts(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Assert>> v);

        UnionBuilder setAsserts(java.util.List<schemarise.alfa.runtime.model.Assert> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Assert>> getAsserts();

        UnionBuilder setLinkages(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Linkage>> v);

        UnionBuilder setLinkages(java.util.List<schemarise.alfa.runtime.model.Linkage> v);

        java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Linkage>> getLinkages();

        UnionBuilder setUnionType(schemarise.alfa.runtime.model.UnionType v);
    ...
    final class _UnionBuilderImpl extends _Union__Base__ implements UnionBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _UnionBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _UnionBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Union.UnionDescriptor.INSTANCE;
        }

        public UnionBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExtendedAttribs", v);
            this._extendedAttribs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_EXTENDEDATTRIBS);
            return this;
        }
        ...
        public UnionBuilder setAnnotations(
                java.util.Optional<
                                java.util.Map<
                                        java.lang.String,
                                        java.util.Map<
            ...
            this._annotations = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_ANNOTATIONS);
            return this;
        }
        ...
        public UnionBuilder setDoc(java.util.Optional<java.lang.String> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Doc", v);
            this._doc = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_DOC);
            return this;
        }

        public UnionBuilder setDoc(java.lang.String v) {
            this._doc = java.util.Optional.ofNullable(v);
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_DOC);
            return this;
        }

        public UnionBuilder setName(schemarise.alfa.runtime.model.UdtVersionedName v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Name", v);
            this._name = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_NAME);
            return this;
        }

        public UnionBuilder setChecksum(java.lang.String v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Checksum", v);
            this._checksum = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_CHECKSUM);
            return this;
        }
        ...
        public UnionBuilder addModifiers(schemarise.alfa.runtime.model.ModifierType e) {
            ...
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_MODIFIERS);
            return this;
        }

        public UnionBuilder addAllModifiers(
        ...
        private UnionBuilder setModifiers(
                java.util.Set<schemarise.alfa.runtime.model.ModifierType> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Modifiers", all);
            this._modifiers = all;
            clearMissingFlag(
        ...
        public UnionBuilder setIncludes(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Includes", v);
            this._includes = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_INCLUDES);
            return this;
        }
        ...
        public UnionBuilder setScope(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtDataType>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Scope", v);
            this._scope = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_SCOPE);
            return this;
        }

        public UnionBuilder setScope(java.util.List<schemarise.alfa.runtime.model.UdtDataType> v) {
            this._scope = java.util.Optional.ofNullable(v);
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_SCOPE);
            return this;
        }

        public UnionBuilder setIncludedFrom(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.UdtVersionedName>>
                        v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("IncludedFrom", v);
            this._includedFrom = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_INCLUDEDFROM);
            return this;
        }
        ...
        public UnionBuilder setModelId(java.util.Optional<java.lang.String> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ModelId", v);
            this._modelId = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_MODELID);
            return this;
        }

        public UnionBuilder setModelId(java.lang.String v) {
        ...
        public UnionBuilder putAllFields(
            ...
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_ALLFIELDS);
            return this;
        }

        public UnionBuilder putAllAllFields(
                java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> all) {
        ...
        private UnionBuilder setAllFields(
                java.util.Map<java.lang.String, schemarise.alfa.runtime.model.Field> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("AllFields", all);
            _allFields = all;
            clearMissingFlag(
        ...
        public UnionBuilder setExtends(
            ...
            this._extends = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_EXTENDS);
            return this;
        }

        public UnionBuilder setExtends(schemarise.alfa.runtime.model.UdtDataType v) {
        ...
        public UnionBuilder addLocalFieldNames(java.lang.String e) {
            ...
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_LOCALFIELDNAMES);
            return this;
        }

        public UnionBuilder setLocalFieldNames(int index, java.lang.String e) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("LocalFieldNames", e);
            if (this._localFieldNames == null) createLocalFieldNames();
        ...
        public UnionBuilder addAllLocalFieldNames(java.util.List<java.lang.String> all) {
        ...
        private UnionBuilder setLocalFieldNames(java.util.List<java.lang.String> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("LocalFieldNames", all);
        ...
        public UnionBuilder setInheritedFields(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.InheritedFields>>
                        v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("InheritedFields", v);
            this._inheritedFields = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_INHERITEDFIELDS);
            return this;
        }
        ...
        public UnionBuilder setIsSynthetic(boolean v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("IsSynthetic", v);
            this._isSynthetic = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_ISSYNTHETIC);
            return this;
        }

        public UnionBuilder setAsserts(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Assert>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Asserts", v);
            this._asserts = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_ASSERTS);
            return this;
        }

        public UnionBuilder setAsserts(java.util.List<schemarise.alfa.runtime.model.Assert> v) {
            this._asserts = java.util.Optional.ofNullable(v);
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_ASSERTS);
            return this;
        }

        public UnionBuilder setLinkages(
                java.util.Optional<java.util.List<schemarise.alfa.runtime.model.Linkage>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Linkages", v);
            this._linkages = v;
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_LINKAGES);
            return this;
        }

        public UnionBuilder setLinkages(java.util.List<schemarise.alfa.runtime.model.Linkage> v) {
            this._linkages = java.util.Optional.ofNullable(v);
            clearMissingFlag(schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_LINKAGES);
            return this;
        }

        public UnionBuilder setUnionType(schemarise.alfa.runtime.model.UnionType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("UnionType", v);
            this._unionType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.FIELD_ID_UNIONTYPE);
            return this;
        }
        ...
        public Union build() {
            ...
            com.schemarise.alfa.runtime.utils.Utils.assertMandatoryFieldsSet(
                    ...
                    __missingFields,
                    20,
                    schemarise.alfa.runtime.model.Union.UnionDescriptor.INSTANCE);
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                                ...
                                builderConfig()
                                        ...
                                        .create(
                                                ...
                                                com.schemarise.alfa.runtime.utils.VectorCloner
                                                        .immutableSet(
                                                                builderConfig(),
                                                                schemarise.alfa.runtime.model.Union
                                                                        .UnionDescriptor.INSTANCE
                ...
                obj =
                        new schemarise.alfa.runtime.model.Union._UnionConcrete(
                                _extendedAttribs,
                                _annotations,
                                _doc,
                                _name,
    ...
    final class _UnionConcrete extends _Union__Base__ implements Union {

        private _UnionConcrete() {
            super();
        }
    ...
    abstract class _Union__Base__ {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof schemarise.alfa.runtime.model.Union._UnionConcrete)) return false;
            schemarise.alfa.runtime.model.Union._UnionConcrete rhs =
                    (schemarise.alfa.runtime.model.Union._UnionConcrete) o;
    ...
    public static final class UnionDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME = "schemarise.alfa.runtime.model.Union";
        public static schemarise.alfa.runtime.model.Union.UnionDescriptor INSTANCE =
                new schemarise.alfa.runtime.model.Union.UnionDescriptor();
        ...
        public static final short FIELD_ID_UNIONTYPE = 19;
        ...
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.Union._UnionBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<Union, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public UnionBuilder builder() {
            return new schemarise.alfa.runtime.model.Union._UnionBuilderImpl();
        }

        @Override
        public UnionBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.Union._UnionBuilderImpl(cc);
        }
        ...
        protected java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Union>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Union>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
