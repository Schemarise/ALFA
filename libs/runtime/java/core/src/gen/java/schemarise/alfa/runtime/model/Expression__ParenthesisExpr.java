...
public interface Expression__ParenthesisExpr extends com.schemarise.alfa.runtime.Record {
    ...
    public static Expression__ParenthesisExprBuilder builder() {
        return new schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                ._Expression__ParenthesisExprBuilderImpl();
    }
    ...
    public static Expression__ParenthesisExprBuilder builder(
        ...
        if (bc.getCustomBuilderFactory().isPresent())
            ...
            return new schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                    ._Expression__ParenthesisExprBuilderImpl(bc);
    }
    ...
    public interface Expression__ParenthesisExprBuilder
            extends com.schemarise.alfa.runtime.Builder, com.schemarise.alfa.runtime.AlfaObject {
        Expression__ParenthesisExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getExprType();

        Expression__ParenthesisExprBuilder setExpr(schemarise.alfa.runtime.model.IExpression v);

        schemarise.alfa.runtime.model.IExpression getExpr();

        Expression__ParenthesisExpr build();
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Builder Impl class">
    final class _Expression__ParenthesisExprBuilderImpl extends _Expression__ParenthesisExpr__Base__
            implements Expression__ParenthesisExprBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _Expression__ParenthesisExprBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _Expression__ParenthesisExprBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                    .Expression__ParenthesisExprDescriptor.INSTANCE;
        }

        public Expression__ParenthesisExprBuilder setExprType(
                schemarise.alfa.runtime.model.IDataType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExprType", v);
            this._exprType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                            .Expression__ParenthesisExprDescriptor.FIELD_ID_EXPRTYPE);
            return this;
        }

        public Expression__ParenthesisExprBuilder setExpr(
                schemarise.alfa.runtime.model.IExpression v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Expr", v);
            this._expr = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                            .Expression__ParenthesisExprDescriptor.FIELD_ID_EXPR);
            return this;
        }
        ...
        public Expression__ParenthesisExpr build() {
            ...
            Expression__ParenthesisExpr obj;

            if (builderConfig().getCustomBuilderFactory().isPresent())
                obj =
                        (Expression__ParenthesisExpr)
                                builderConfig()
                                        .getCustomBuilderFactory()
                                        .get()
                                        .create(builderConfig(), descriptor(), _exprType, _expr);
            else
                obj =
                        new schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                                ._Expression__ParenthesisExprConcrete(_exprType, _expr);
    ...
    final class _Expression__ParenthesisExprConcrete extends _Expression__ParenthesisExpr__Base__
            implements Expression__ParenthesisExpr {

        private _Expression__ParenthesisExprConcrete() {
            super();
        }
    ...
    abstract class _Expression__ParenthesisExpr__Base__ {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o
                    instanceof
                    schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                            ._Expression__ParenthesisExprConcrete)) return false;
            schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                            ._Expression__ParenthesisExprConcrete
                    rhs =
                            (schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                                            ._Expression__ParenthesisExprConcrete)
                                    o;
    ...
    public static final class Expression__ParenthesisExprDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME =
                "schemarise.alfa.runtime.model.Expression__ParenthesisExpr";
        public static schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                        .Expression__ParenthesisExprDescriptor
                INSTANCE =
                        new schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                                .Expression__ParenthesisExprDescriptor();
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                Expression__ParenthesisExpr, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public Expression__ParenthesisExprBuilder builder() {
            return new schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                    ._Expression__ParenthesisExprBuilderImpl();
        }
        ...
        public Expression__ParenthesisExprBuilder builder(
            ...
            return new schemarise.alfa.runtime.model.Expression__ParenthesisExpr
                    ._Expression__ParenthesisExprBuilderImpl(cc);
        }

        public Expression__ParenthesisExprDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<
                        java.lang.String,
                        com.schemarise.alfa.runtime.FieldMeta<Expression__ParenthesisExpr>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.Expression__ParenthesisExpr{ExprType:schemarise.alfa.runtime.model.IDataType[4404d6a0];expr:schemarise.alfa.runtime.model.IExpression[5fb330b3];}
            schemarise.alfa.runtime.model.Expression__ParenthesisExpr{ExprType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];expr:schemarise.alfa.runtime.model.IExpression[5fb330b3];}
            */
            return "4df18f:9a646d11";
        }
    }
    // </editor-fold>
