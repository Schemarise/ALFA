...
public interface Expression__MathExpr extends com.schemarise.alfa.runtime.Record {

    schemarise.alfa.runtime.model.IDataType getExprType();

    schemarise.alfa.runtime.model.IExpression getLhs();

    schemarise.alfa.runtime.model.MathOperatorType getOperator();

    schemarise.alfa.runtime.model.IExpression getRhs();

    // <editor-fold defaultstate="collapsed" desc="Builder support">
    public static Expression__MathExprBuilder builder() {
        return new schemarise.alfa.runtime.model.Expression__MathExpr
                ._Expression__MathExprBuilderImpl();
    }
    ...
    public static Expression__MathExprBuilder builder(
        ...
        if (bc.getCustomBuilderFactory().isPresent())
            ...
            return new schemarise.alfa.runtime.model.Expression__MathExpr
                    ._Expression__MathExprBuilderImpl(bc);
    }
    ...
    public interface Expression__MathExprBuilder
            extends com.schemarise.alfa.runtime.Builder, com.schemarise.alfa.runtime.AlfaObject {
        Expression__MathExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getExprType();

        Expression__MathExprBuilder setLhs(schemarise.alfa.runtime.model.IExpression v);

        schemarise.alfa.runtime.model.IExpression getLhs();

        Expression__MathExprBuilder setOperator(schemarise.alfa.runtime.model.MathOperatorType v);

        schemarise.alfa.runtime.model.MathOperatorType getOperator();

        Expression__MathExprBuilder setRhs(schemarise.alfa.runtime.model.IExpression v);

        schemarise.alfa.runtime.model.IExpression getRhs();

        Expression__MathExpr build();
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Builder Impl class">
    final class _Expression__MathExprBuilderImpl extends _Expression__MathExpr__Base__
            implements Expression__MathExprBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _Expression__MathExprBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _Expression__MathExprBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Expression__MathExpr.Expression__MathExprDescriptor
                    .INSTANCE;
        }

        public Expression__MathExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExprType", v);
            this._exprType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__MathExpr
                            .Expression__MathExprDescriptor.FIELD_ID_EXPRTYPE);
            return this;
        }

        public Expression__MathExprBuilder setLhs(schemarise.alfa.runtime.model.IExpression v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Lhs", v);
            this._lhs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__MathExpr
                            .Expression__MathExprDescriptor.FIELD_ID_LHS);
            return this;
        }

        public Expression__MathExprBuilder setOperator(
                schemarise.alfa.runtime.model.MathOperatorType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Operator", v);
            this._operator = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__MathExpr
                            .Expression__MathExprDescriptor.FIELD_ID_OPERATOR);
            return this;
        }

        public Expression__MathExprBuilder setRhs(schemarise.alfa.runtime.model.IExpression v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Rhs", v);
            this._rhs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__MathExpr
                            .Expression__MathExprDescriptor.FIELD_ID_RHS);
            return this;
        }
        ...
        public void modify(java.lang.String fieldName, java.lang.Object val) {
            switch (fieldName) {
                ...
                case "lhs":
                    ...
                    break;
                case "operator":
                    setOperator((schemarise.alfa.runtime.model.MathOperatorType) val);
                    break;
                case "rhs":
        ...
        public Expression__MathExpr build() {
            ...
            Expression__MathExpr obj;

            if (builderConfig().getCustomBuilderFactory().isPresent())
                obj =
                        (Expression__MathExpr)
                                builderConfig()
                ...
                obj =
                        new schemarise.alfa.runtime.model.Expression__MathExpr
                                ._Expression__MathExprConcrete(_exprType, _lhs, _operator, _rhs);
    ...
    final class _Expression__MathExprConcrete extends _Expression__MathExpr__Base__
            implements Expression__MathExpr {

        private _Expression__MathExprConcrete() {
            super();
        }
        ...
        private _Expression__MathExprConcrete(
                ...
                schemarise.alfa.runtime.model.MathOperatorType _operator,
    ...
    abstract class _Expression__MathExpr__Base__ {
        ...
        public schemarise.alfa.runtime.model.MathOperatorType getOperator() {
            return _operator;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o
                    instanceof
                    schemarise.alfa.runtime.model.Expression__MathExpr
                            ._Expression__MathExprConcrete)) return false;
            schemarise.alfa.runtime.model.Expression__MathExpr._Expression__MathExprConcrete rhs =
                    (schemarise.alfa.runtime.model.Expression__MathExpr
                                    ._Expression__MathExprConcrete)
                            o;
    ...
    public static final class Expression__MathExprDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME =
                "schemarise.alfa.runtime.model.Expression__MathExpr";
        public static schemarise.alfa.runtime.model.Expression__MathExpr
                        .Expression__MathExprDescriptor
                INSTANCE =
                        new schemarise.alfa.runtime.model.Expression__MathExpr
                                .Expression__MathExprDescriptor();
        ...
        private schemarise.alfa.runtime.model.UdtDataType _operatorType =
                schemarise.alfa.runtime.model.UdtDataType.builder()
                        .setFullyQualifiedName("schemarise.alfa.runtime.model.MathOperatorType")
        ...
        /* -- Consumer schemarise.alfa.runtime.model.MathOperatorType -- */
        java.util.function.Function<
                        com.schemarise.alfa.runtime.DataSupplier,
                        schemarise.alfa.runtime.model.MathOperatorType>
        ...
        /* -- Supplier schemarise.alfa.runtime.model.MathOperatorType -- */
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.MathOperatorType,
                        com.schemarise.alfa.runtime.DataConsumer>
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                Expression__MathExpr, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public Expression__MathExprBuilder builder() {
            return new schemarise.alfa.runtime.model.Expression__MathExpr
                    ._Expression__MathExprBuilderImpl();
        }

        @Override
        public Expression__MathExprBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.Expression__MathExpr
                    ._Expression__MathExprBuilderImpl(cc);
        }

        public Expression__MathExprDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<
                        java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Expression__MathExpr>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.Expression__MathExpr{ExprType:schemarise.alfa.runtime.model.IDataType[4404d6a0];lhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];operator:schemarise.alfa.runtime.model.MathOperatorType[c320399f];rhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];}
            schemarise.alfa.runtime.model.Expression__MathExpr{ExprType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];lhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];operator:schemarise.alfa.runtime.model.MathOperatorType[c320399f];rhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];}
            */
            return "d1e38263:a54880db";
        }
    }
    // </editor-fold>
