...
public interface Statement__LetStmt extends com.schemarise.alfa.runtime.Record {
    ...
    public static Statement__LetStmtBuilder builder() {
        return new schemarise.alfa.runtime.model.Statement__LetStmt
                ._Statement__LetStmtBuilderImpl();
    }

    public static Statement__LetStmtBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            ...
            return new schemarise.alfa.runtime.model.Statement__LetStmt
                    ._Statement__LetStmtBuilderImpl(bc);
    }
    ...
    public interface Statement__LetStmtBuilder
            extends com.schemarise.alfa.runtime.Builder, com.schemarise.alfa.runtime.AlfaObject {
        Statement__LetStmtBuilder setName(java.lang.String v);

        java.lang.String getName();

        Statement__LetStmtBuilder setDataType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getDataType();

        Statement__LetStmtBuilder setExpr(schemarise.alfa.runtime.model.IExpression v);

        schemarise.alfa.runtime.model.IExpression getExpr();

        Statement__LetStmt build();
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Builder Impl class">
    final class _Statement__LetStmtBuilderImpl extends _Statement__LetStmt__Base__
            implements Statement__LetStmtBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _Statement__LetStmtBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _Statement__LetStmtBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Statement__LetStmt.Statement__LetStmtDescriptor
                    .INSTANCE;
        }

        public Statement__LetStmtBuilder setName(java.lang.String v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Name", v);
            this._name = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Statement__LetStmt.Statement__LetStmtDescriptor
                            .FIELD_ID_NAME);
            return this;
        }

        public Statement__LetStmtBuilder setDataType(schemarise.alfa.runtime.model.IDataType v) {
        ...
        public Statement__LetStmtBuilder setExpr(schemarise.alfa.runtime.model.IExpression v) {
        ...
        public Statement__LetStmt build() {
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                ...
                obj =
                        new schemarise.alfa.runtime.model.Statement__LetStmt
                                ._Statement__LetStmtConcrete(_name, _dataType, _expr);
        ...
        public java.lang.String toString() {
            return com.schemarise.alfa.runtime.utils.Utils.udtToString(
                    "schemarise.alfa.runtime.model.Statement__LetStmt",
                    new java.lang.String[] {"Name", "dataType", "Expr"},
                    new java.lang.Object[] {_name, _dataType, _expr});
        }
    }
    // </editor-fold>
    ...
    final class _Statement__LetStmtConcrete extends _Statement__LetStmt__Base__
            implements Statement__LetStmt {

        private _Statement__LetStmtConcrete() {
            super();
        }
    ...
    abstract class _Statement__LetStmt__Base__ {
        ...
        public int hashCode() {
            return java.util.Objects.hash(_name, _dataType, _expr);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o
                    instanceof
                    schemarise.alfa.runtime.model.Statement__LetStmt._Statement__LetStmtConcrete))
                return false;
            schemarise.alfa.runtime.model.Statement__LetStmt._Statement__LetStmtConcrete rhs =
                    (schemarise.alfa.runtime.model.Statement__LetStmt._Statement__LetStmtConcrete)
                            o;
    ...
    public static final class Statement__LetStmtDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME =
                "schemarise.alfa.runtime.model.Statement__LetStmt";
        public static schemarise.alfa.runtime.model.Statement__LetStmt.Statement__LetStmtDescriptor
                INSTANCE =
                        new schemarise.alfa.runtime.model.Statement__LetStmt
                                .Statement__LetStmtDescriptor();
        ...
        public static final short FIELD_ID_EXPR = 2;
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                Statement__LetStmt, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public Statement__LetStmtBuilder builder() {
            return new schemarise.alfa.runtime.model.Statement__LetStmt
                    ._Statement__LetStmtBuilderImpl();
        }

        @Override
        public Statement__LetStmtBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.Statement__LetStmt
                    ._Statement__LetStmtBuilderImpl(cc);
        }

        public Statement__LetStmtDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<
                        java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Statement__LetStmt>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Statement__LetStmt>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.Statement__LetStmt{Expr:schemarise.alfa.runtime.model.IExpression[5fb330b3];Name:string;dataType:schemarise.alfa.runtime.model.IDataType[4404d6a0];}
            schemarise.alfa.runtime.model.Statement__LetStmt{Expr:schemarise.alfa.runtime.model.IExpression[5fb330b3];Name:string;dataType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];}
            */
            return "f8a48516:88735aa5";
        }
    }
    // </editor-fold>
