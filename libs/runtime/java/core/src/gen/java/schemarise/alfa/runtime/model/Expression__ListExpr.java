...
public interface Expression__ListExpr extends com.schemarise.alfa.runtime.Record {

    schemarise.alfa.runtime.model.IDataType getExprType();

    java.util.List<schemarise.alfa.runtime.model.IExpression> getExpr();

    // <editor-fold defaultstate="collapsed" desc="Builder support">
    public static Expression__ListExprBuilder builder() {
        return new schemarise.alfa.runtime.model.Expression__ListExpr
                ._Expression__ListExprBuilderImpl();
    }
    ...
    public static Expression__ListExprBuilder builder(
        ...
        if (bc.getCustomBuilderFactory().isPresent())
            ...
            return new schemarise.alfa.runtime.model.Expression__ListExpr
                    ._Expression__ListExprBuilderImpl(bc);
    }
    ...
    public interface Expression__ListExprBuilder
            extends com.schemarise.alfa.runtime.Builder, com.schemarise.alfa.runtime.AlfaObject {
        Expression__ListExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getExprType();

        Expression__ListExprBuilder addExpr(schemarise.alfa.runtime.model.IExpression e);

        Expression__ListExprBuilder addAllExpr(
                java.util.List<schemarise.alfa.runtime.model.IExpression> all);

        java.util.List<schemarise.alfa.runtime.model.IExpression> getExpr();

        Expression__ListExpr build();
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Builder Impl class">
    final class _Expression__ListExprBuilderImpl extends _Expression__ListExpr__Base__
            implements Expression__ListExprBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _Expression__ListExprBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _Expression__ListExprBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Expression__ListExpr.Expression__ListExprDescriptor
                    .INSTANCE;
        }

        public Expression__ListExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExprType", v);
            this._exprType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__ListExpr
                            .Expression__ListExprDescriptor.FIELD_ID_EXPRTYPE);
            return this;
        }
        ...
        public Expression__ListExprBuilder addExpr(schemarise.alfa.runtime.model.IExpression e) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Expr", e);
            if (this._expr == null) createExpr();
            this._expr.add(e);
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__ListExpr
                            .Expression__ListExprDescriptor.FIELD_ID_EXPR);
            return this;
        }

        public Expression__ListExprBuilder setExpr(
        ...
        public Expression__ListExprBuilder addAllExpr(
                java.util.List<schemarise.alfa.runtime.model.IExpression> all) {
        ...
        private Expression__ListExprBuilder setExpr(
                java.util.List<schemarise.alfa.runtime.model.IExpression> all) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Expr", all);
            this._expr = all;
            clearMissingFlag(
        ...
        public void modify(java.lang.String fieldName, java.lang.Object val) {
            switch (fieldName) {
                case "ExprType":
                    ...
                    break;
                case "expr":
                    setExpr((java.util.List<schemarise.alfa.runtime.model.IExpression>) val);
                    break;
                default:
        ...
        public Expression__ListExpr build() {
            ...
            Expression__ListExpr obj;

            if (builderConfig().getCustomBuilderFactory().isPresent())
                obj =
                        (Expression__ListExpr)
                                builderConfig()
                                                ...
                                                com.schemarise.alfa.runtime.utils.VectorCloner
                                                        .immutableList(
                                                                ...
                                                                schemarise.alfa.runtime.model
                                                                        .Expression__ListExpr
                                                                        .Expression__ListExprDescriptor
                                                                        .INSTANCE
                                                                        ._exprSupplierInner1,
                                                                _expr));
            else
                obj =
                        new schemarise.alfa.runtime.model.Expression__ListExpr
                                ._Expression__ListExprConcrete(
                                _exprType,
    ...
    final class _Expression__ListExprConcrete extends _Expression__ListExpr__Base__
            implements Expression__ListExpr {

        private _Expression__ListExprConcrete() {
            super();
        }

        private _Expression__ListExprConcrete(
                schemarise.alfa.runtime.model.IDataType _exprType,
                java.util.List<schemarise.alfa.runtime.model.IExpression> _expr) {
    ...
    abstract class _Expression__ListExpr__Base__ {
        public schemarise.alfa.runtime.model.IDataType _exprType;
        public java.util.List<schemarise.alfa.runtime.model.IExpression> _expr;

        public _Expression__ListExpr__Base__() {}
        ...
        public java.util.List<schemarise.alfa.runtime.model.IExpression> getExpr() {
            return _expr;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o
                    instanceof
                    schemarise.alfa.runtime.model.Expression__ListExpr
                            ._Expression__ListExprConcrete)) return false;
            schemarise.alfa.runtime.model.Expression__ListExpr._Expression__ListExprConcrete rhs =
                    (schemarise.alfa.runtime.model.Expression__ListExpr
                                    ._Expression__ListExprConcrete)
                            o;
    ...
    public static final class Expression__ListExprDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME =
                "schemarise.alfa.runtime.model.Expression__ListExpr";
        public static schemarise.alfa.runtime.model.Expression__ListExpr
                        .Expression__ListExprDescriptor
                INSTANCE =
                        new schemarise.alfa.runtime.model.Expression__ListExpr
                                .Expression__ListExprDescriptor();
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                Expression__ListExpr, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public Expression__ListExprBuilder builder() {
            return new schemarise.alfa.runtime.model.Expression__ListExpr
                    ._Expression__ListExprBuilderImpl();
        }

        @Override
        public Expression__ListExprBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.Expression__ListExpr
                    ._Expression__ListExprBuilderImpl(cc);
        }

        public Expression__ListExprDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<
                        java.lang.String, com.schemarise.alfa.runtime.FieldMeta<Expression__ListExpr>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.Expression__ListExpr{ExprType:schemarise.alfa.runtime.model.IDataType[4404d6a0];expr:list<schemarise.alfa.runtime.model.IExpression[5fb330b3]>;}
            schemarise.alfa.runtime.model.Expression__ListExpr{ExprType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];expr:list<schemarise.alfa.runtime.model.IExpression[5fb330b3]>;}
            */
            return "24d2aa10:3af6caa0";
        }
    }
    // </editor-fold>
