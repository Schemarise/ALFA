...
public interface IAttribute
    ...
    public static com.schemarise.alfa.runtime.TypeDescriptor descriptor =
            new schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor();
    ...
    public static IAttributeBuilder builder() {
        return new schemarise.alfa.runtime.model.IAttribute._IAttributeBuilderImpl();
    }

    public static IAttributeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            return bc.getCustomBuilderFactory()
                    .get()
                    .builder(
                            bc,
                            schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor.INSTANCE);
        else return new schemarise.alfa.runtime.model.IAttribute._IAttributeBuilderImpl(bc);
    }
    ...
    public interface IAttributeBuilder
        ...
        IAttributeBuilder setAnnotations(
                java.util.Optional<
                                java.util.Map<
                                        java.lang.String,
                                        java.util.Map<
        ...
        IAttributeBuilder setDoc(java.util.Optional<java.lang.String> v);

        IAttributeBuilder setDoc(java.lang.String v);

        java.util.Optional<java.lang.String> getDoc();

        IAttributeBuilder setName(java.lang.String v);

        java.lang.String getName();

        IAttributeBuilder setDataType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getDataType();

        IAttributeBuilder setSrcLocation(
                java.util.Optional<schemarise.alfa.runtime.model.Location> v);

        IAttributeBuilder setSrcLocation(schemarise.alfa.runtime.model.Location v);

        java.util.Optional<schemarise.alfa.runtime.model.Location> getSrcLocation();

        IAttributeBuilder setDefaultValue(
                java.util.Optional<schemarise.alfa.runtime.model.IExpression> v);

        IAttributeBuilder setDefaultValue(schemarise.alfa.runtime.model.IExpression v);
    ...
    final class _IAttributeBuilderImpl extends _IAttribute__Base__ implements IAttributeBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _IAttributeBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _IAttributeBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor.INSTANCE;
        }

        public IAttributeBuilder setAnnotations(
                java.util.Optional<
                                java.util.Map<
                                        java.lang.String,
                                        java.util.Map<
            ...
            this._annotations = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor
        ...
        public IAttributeBuilder setDoc(java.util.Optional<java.lang.String> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Doc", v);
            this._doc = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor.FIELD_ID_DOC);
            return this;
        }

        public IAttributeBuilder setDoc(java.lang.String v) {
        ...
        public IAttributeBuilder setName(java.lang.String v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Name", v);
            this._name = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor.FIELD_ID_NAME);
            return this;
        }

        public IAttributeBuilder setDataType(schemarise.alfa.runtime.model.IDataType v) {
        ...
        public IAttributeBuilder setSrcLocation(
                java.util.Optional<schemarise.alfa.runtime.model.Location> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("SrcLocation", v);
            this._srcLocation = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor
                            .FIELD_ID_SRCLOCATION);
            return this;
        }

        public IAttributeBuilder setSrcLocation(schemarise.alfa.runtime.model.Location v) {
        ...
        public IAttributeBuilder setDefaultValue(
                java.util.Optional<schemarise.alfa.runtime.model.IExpression> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("DefaultValue", v);
            this._defaultValue = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor
                            .FIELD_ID_DEFAULTVALUE);
            return this;
        }

        public IAttributeBuilder setDefaultValue(schemarise.alfa.runtime.model.IExpression v) {
        ...
        public IAttribute build() {
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                ...
                obj =
                        new schemarise.alfa.runtime.model.IAttribute._IAttributeConcrete(
    ...
    final class _IAttributeConcrete extends _IAttribute__Base__ implements IAttribute {

        private _IAttributeConcrete() {
            super();
        }
    ...
    abstract class _IAttribute__Base__ {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof schemarise.alfa.runtime.model.IAttribute._IAttributeConcrete))
                return false;
            schemarise.alfa.runtime.model.IAttribute._IAttributeConcrete rhs =
                    (schemarise.alfa.runtime.model.IAttribute._IAttributeConcrete) o;
    ...
    public static final class IAttributeDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME = "schemarise.alfa.runtime.model.IAttribute";
        public static schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor INSTANCE =
                new schemarise.alfa.runtime.model.IAttribute.IAttributeDescriptor();
        ...
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.IAttribute._IAttributeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                IAttribute, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public IAttributeBuilder builder() {
            return new schemarise.alfa.runtime.model.IAttribute._IAttributeBuilderImpl();
        }

        @Override
        public IAttributeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.IAttribute._IAttributeBuilderImpl(cc);
        }

        public IAttributeDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<IAttribute>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<IAttribute>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.IAttribute{Annotations:optional<map<string,string>;>;DataType:schemarise.alfa.runtime.model.IDataType[4404d6a0];DefaultValue:optional<schemarise.alfa.runtime.model.IExpression[5fb330b3];>;Doc:optional<string;>;Name:string;SrcLocation:optional<schemarise.alfa.runtime.model.Location[946b249f];>;}
            schemarise.alfa.runtime.model.IAttribute{DataType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];Name:string;}
            */
            return "37fd69e5:b62a7c97";
        }
    }
    // </editor-fold>
}
