...
public interface ErrorDataType
    ...
    public static ErrorDataTypeBuilder builder() {
        return new schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeBuilderImpl();
    }

    public static ErrorDataTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            return bc.getCustomBuilderFactory()
                    .get()
                    .builder(
                            bc,
                            schemarise.alfa.runtime.model.ErrorDataType.ErrorDataTypeDescriptor
                                    .INSTANCE);
        else return new schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeBuilderImpl(bc);
    }
    ...
    public interface ErrorDataTypeBuilder
        ...
        ErrorDataTypeBuilder setExtendedAttribs(
        ...
        ErrorDataTypeBuilder setTypeDefName(java.util.Optional<java.lang.String> v);

        ErrorDataTypeBuilder setTypeDefName(java.lang.String v);

        java.util.Optional<java.lang.String> getTypeDefName();

        ErrorDataTypeBuilder setLocation(java.lang.String v);

        java.lang.String getLocation();

        ErrorDataTypeBuilder setMessage(java.lang.String v);
    ...
    final class _ErrorDataTypeBuilderImpl extends _ErrorDataType__Base__
            implements ErrorDataTypeBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _ErrorDataTypeBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _ErrorDataTypeBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.ErrorDataType.ErrorDataTypeDescriptor.INSTANCE;
        }

        public ErrorDataTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v) {
        ...
        public ErrorDataTypeBuilder setTypeDefName(java.util.Optional<java.lang.String> v) {
        ...
        public ErrorDataTypeBuilder setTypeDefName(java.lang.String v) {
        ...
        public ErrorDataTypeBuilder setLocation(java.lang.String v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Location", v);
            this._location = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.ErrorDataType.ErrorDataTypeDescriptor
                            .FIELD_ID_LOCATION);
        ...
        public ErrorDataTypeBuilder setMessage(java.lang.String v) {
        ...
        public void modify(java.lang.String fieldName, java.lang.Object val) {
            switch (fieldName) {
                ...
                case "TypeDefName":
                    ...
                    break;
                case "Location":
                    setLocation((java.lang.String) val);
                    break;
                case "Message":
        ...
        public ErrorDataType build() {
            ...
            com.schemarise.alfa.runtime.utils.Utils.assertMandatoryFieldsSet(
                    ...
                    __missingFields,
                    4,
                    schemarise.alfa.runtime.model.ErrorDataType.ErrorDataTypeDescriptor.INSTANCE);
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                ...
                obj =
                        new schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeConcrete(
                                _extendedAttribs, _typeDefName, _location, _message);
        ...
        public java.lang.String toString() {
            return com.schemarise.alfa.runtime.utils.Utils.udtToString(
                    "schemarise.alfa.runtime.model.ErrorDataType",
                    new java.lang.String[] {
                        "ExtendedAttribs", "TypeDefName", "Location", "Message"
                    },
                    new java.lang.Object[] {_extendedAttribs, _typeDefName, _location, _message});
        }
    }
    // </editor-fold>
    ...
    final class _ErrorDataTypeConcrete extends _ErrorDataType__Base__ implements ErrorDataType {

        private _ErrorDataTypeConcrete() {
            super();
        }
        ...
        private _ErrorDataTypeConcrete(
            ...
            super(_extendedAttribs, _typeDefName, _location, _message);
        }
    }
    ...
    abstract class _ErrorDataType__Base__ {
        ...
        public java.lang.String _location;
        public java.lang.String _message;

        public _ErrorDataType__Base__() {}
        ...
        public int hashCode() {
            return java.util.Objects.hash(_extendedAttribs, _typeDefName, _location, _message);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeConcrete))
                return false;
            schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeConcrete rhs =
                    (schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeConcrete) o;
            return java.util.Objects.equals(_extendedAttribs, rhs._extendedAttribs)
                    ...
                    && java.util.Objects.equals(_location, rhs._location)
    ...
    public static final class ErrorDataTypeDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME = "schemarise.alfa.runtime.model.ErrorDataType";
        public static schemarise.alfa.runtime.model.ErrorDataType.ErrorDataTypeDescriptor INSTANCE =
                new schemarise.alfa.runtime.model.ErrorDataType.ErrorDataTypeDescriptor();
        ...
        public static final short FIELD_ID_LOCATION = 2;
        ...
        private schemarise.alfa.runtime.model.ScalarDataType _locationType =
                schemarise.alfa.runtime.model.ScalarDataType.builder()
        ...
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
        ...
        java.util.function.Function<com.schemarise.alfa.runtime.DataSupplier, java.lang.String>
                _locationConsumerInner1 =
                        (supplierInner1) -> {
                            return supplierInner1.stringValue(
                                    ((schemarise.alfa.runtime.model.ScalarDataType) _locationType));
                        };
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
                _locationConsumer =
                        (builder, supplier) -> {
                            builder.setLocation(_locationConsumerInner1.apply(supplier));
                        };
        /* -- Consumer string -- */
        java.util.function.Function<com.schemarise.alfa.runtime.DataSupplier, java.lang.String>
        ...
        private java.util.function.BiConsumer<
                ...
                _locationSupplier =
                        (p, consumer) -> {
                            _locationSupplierInner1.accept(p.getLocation(), consumer);
                        };
        /* -- Supplier string -- */
        java.util.function.BiConsumer<java.lang.String, com.schemarise.alfa.runtime.DataConsumer>
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                ErrorDataType, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        public com.schemarise.alfa.runtime.FieldMeta typeDefNameMeta =
                new com.schemarise.alfa.runtime.FieldMeta(
                        ...
                        FIELD_TYPEDEFNAME,
                        java.util.Optional.empty());
        public com.schemarise.alfa.runtime.FieldMeta locationMeta =
                new com.schemarise.alfa.runtime.FieldMeta(
                        java.util.Optional.of(_locationSupplier),
                        java.util.Optional.of(_locationConsumer),
                        java.util.Optional.of(_locationSupplierInner1),
                        java.util.Optional.of(_locationConsumerInner1),
                        _locationType,
                        FIELD_LOCATION,
                        java.util.Optional.empty());
        ...
        @Override
        public ErrorDataTypeBuilder builder() {
            return new schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeBuilderImpl();
        }

        @Override
        public ErrorDataTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.ErrorDataType._ErrorDataTypeBuilderImpl(cc);
        }

        public ErrorDataTypeDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<ErrorDataType>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
                                        ...
                                        put(FIELD_LOCATION, locationMeta);
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<ErrorDataType>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.ErrorDataType{ExtendedAttribs:optional<map<string,string>;>;Location:string;Message:string;TypeDefName:optional<string;>;}
            schemarise.alfa.runtime.model.ErrorDataType{Location:string;Message:string;}
            */
            return "828a3209:6dd3d4c5";
        }
    }
    // </editor-fold>
