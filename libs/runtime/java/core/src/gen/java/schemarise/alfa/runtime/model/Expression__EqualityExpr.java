...
public interface Expression__EqualityExpr extends com.schemarise.alfa.runtime.Record {
    ...
    public static Expression__EqualityExprBuilder builder() {
        return new schemarise.alfa.runtime.model.Expression__EqualityExpr
                ._Expression__EqualityExprBuilderImpl();
    }
    ...
    public static Expression__EqualityExprBuilder builder(
        ...
        if (bc.getCustomBuilderFactory().isPresent())
            ...
            return new schemarise.alfa.runtime.model.Expression__EqualityExpr
                    ._Expression__EqualityExprBuilderImpl(bc);
    }
    ...
    public interface Expression__EqualityExprBuilder
            extends com.schemarise.alfa.runtime.Builder, com.schemarise.alfa.runtime.AlfaObject {
        Expression__EqualityExprBuilder setExprType(schemarise.alfa.runtime.model.IDataType v);

        schemarise.alfa.runtime.model.IDataType getExprType();

        Expression__EqualityExprBuilder setLhs(schemarise.alfa.runtime.model.IExpression v);

        schemarise.alfa.runtime.model.IExpression getLhs();

        Expression__EqualityExprBuilder setOperator(
                schemarise.alfa.runtime.model.EqualityOperatorType v);

        schemarise.alfa.runtime.model.EqualityOperatorType getOperator();

        Expression__EqualityExprBuilder setRhs(schemarise.alfa.runtime.model.IExpression v);

        schemarise.alfa.runtime.model.IExpression getRhs();

        Expression__EqualityExpr build();
    }
    // </editor-fold>

    // <editor-fold defaultstate="collapsed" desc="Builder Impl class">
    final class _Expression__EqualityExprBuilderImpl extends _Expression__EqualityExpr__Base__
            implements Expression__EqualityExprBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _Expression__EqualityExprBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _Expression__EqualityExprBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.Expression__EqualityExpr
                    .Expression__EqualityExprDescriptor.INSTANCE;
        }

        public Expression__EqualityExprBuilder setExprType(
                schemarise.alfa.runtime.model.IDataType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExprType", v);
            this._exprType = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__EqualityExpr
                            .Expression__EqualityExprDescriptor.FIELD_ID_EXPRTYPE);
            return this;
        }

        public Expression__EqualityExprBuilder setLhs(schemarise.alfa.runtime.model.IExpression v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Lhs", v);
            this._lhs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__EqualityExpr
                            .Expression__EqualityExprDescriptor.FIELD_ID_LHS);
            return this;
        }

        public Expression__EqualityExprBuilder setOperator(
                schemarise.alfa.runtime.model.EqualityOperatorType v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Operator", v);
            this._operator = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__EqualityExpr
                            .Expression__EqualityExprDescriptor.FIELD_ID_OPERATOR);
            return this;
        }

        public Expression__EqualityExprBuilder setRhs(schemarise.alfa.runtime.model.IExpression v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("Rhs", v);
            this._rhs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.Expression__EqualityExpr
                            .Expression__EqualityExprDescriptor.FIELD_ID_RHS);
            return this;
        }
        ...
        public Expression__EqualityExpr build() {
            ...
            Expression__EqualityExpr obj;

            if (builderConfig().getCustomBuilderFactory().isPresent())
                obj =
                        (Expression__EqualityExpr)
                                builderConfig()
                ...
                obj =
                        new schemarise.alfa.runtime.model.Expression__EqualityExpr
                                ._Expression__EqualityExprConcrete(
    ...
    final class _Expression__EqualityExprConcrete extends _Expression__EqualityExpr__Base__
            implements Expression__EqualityExpr {

        private _Expression__EqualityExprConcrete() {
            super();
        }
    ...
    abstract class _Expression__EqualityExpr__Base__ {
        ...
        public _Expression__EqualityExpr__Base__() {}
        ...
        public boolean equals(Object o) {
            ...
            if (!(o
                    instanceof
                    schemarise.alfa.runtime.model.Expression__EqualityExpr
                            ._Expression__EqualityExprConcrete)) return false;
            schemarise.alfa.runtime.model.Expression__EqualityExpr._Expression__EqualityExprConcrete
                    rhs =
                            (schemarise.alfa.runtime.model.Expression__EqualityExpr
                                            ._Expression__EqualityExprConcrete)
                                    o;
    ...
    public static final class Expression__EqualityExprDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME =
                "schemarise.alfa.runtime.model.Expression__EqualityExpr";
        public static schemarise.alfa.runtime.model.Expression__EqualityExpr
                        .Expression__EqualityExprDescriptor
                INSTANCE =
                        new schemarise.alfa.runtime.model.Expression__EqualityExpr
                                .Expression__EqualityExprDescriptor();
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                Expression__EqualityExpr, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public Expression__EqualityExprBuilder builder() {
            return new schemarise.alfa.runtime.model.Expression__EqualityExpr
                    ._Expression__EqualityExprBuilderImpl();
        }

        @Override
        public Expression__EqualityExprBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.Expression__EqualityExpr
                    ._Expression__EqualityExprBuilderImpl(cc);
        }

        public Expression__EqualityExprDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<
                        java.lang.String,
                        com.schemarise.alfa.runtime.FieldMeta<Expression__EqualityExpr>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.Expression__EqualityExpr{ExprType:schemarise.alfa.runtime.model.IDataType[4404d6a0];lhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];operator:schemarise.alfa.runtime.model.EqualityOperatorType[5dca8e5a];rhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];}
            schemarise.alfa.runtime.model.Expression__EqualityExpr{ExprType:schemarise.alfa.runtime.model.IDataType[5fbc41ae];lhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];operator:schemarise.alfa.runtime.model.EqualityOperatorType[5dca8e5a];rhs:schemarise.alfa.runtime.model.IExpression[5fb330b3];}
            */
            return "b9801df9:78597fe5";
        }
    }
    // </editor-fold>
