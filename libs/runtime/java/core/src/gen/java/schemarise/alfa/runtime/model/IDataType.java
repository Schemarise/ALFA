...
public interface IDataType
        extends com.schemarise.alfa.runtime.Trait, schemarise.alfa.runtime.model.ExtendedAttribs {

    public static com.schemarise.alfa.runtime.TypeDescriptor descriptor =
            new schemarise.alfa.runtime.model.IDataType.IDataTypeDescriptor();

    java.util.Optional<java.lang.String> getTypeDefName();

    // <editor-fold defaultstate="collapsed" desc="Builder support">
    public static IDataTypeBuilder builder() {
        return new schemarise.alfa.runtime.model.IDataType._IDataTypeBuilderImpl();
    }

    public static IDataTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig bc) {
        if (bc.getCustomBuilderFactory().isPresent())
            return bc.getCustomBuilderFactory()
                    .get()
                    .builder(
                            bc,
                            schemarise.alfa.runtime.model.IDataType.IDataTypeDescriptor.INSTANCE);
        else return new schemarise.alfa.runtime.model.IDataType._IDataTypeBuilderImpl(bc);
    }
    ...
    public interface IDataTypeBuilder
        ...
        IDataTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v);

        IDataTypeBuilder setExtendedAttribs(java.util.Map<java.lang.String, java.lang.String> v);

        java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> getExtendedAttribs();

        IDataTypeBuilder setTypeDefName(java.util.Optional<java.lang.String> v);

        IDataTypeBuilder setTypeDefName(java.lang.String v);
    ...
    final class _IDataTypeBuilderImpl extends _IDataType__Base__ implements IDataTypeBuilder {
        private final com.schemarise.alfa.runtime.IBuilderConfig __builderConfig;

        private java.util.BitSet __missingFields;

        private _IDataTypeBuilderImpl() {
            this(com.schemarise.alfa.runtime.BuilderConfig.getInstance());
        }

        private _IDataTypeBuilderImpl(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            __builderConfig = cc;
        ...
        public com.schemarise.alfa.runtime.TypeDescriptor descriptor() {
            return schemarise.alfa.runtime.model.IDataType.IDataTypeDescriptor.INSTANCE;
        }

        public IDataTypeBuilder setExtendedAttribs(
                java.util.Optional<java.util.Map<java.lang.String, java.lang.String>> v) {
            com.schemarise.alfa.runtime.utils.AlfaUtils.notNull("ExtendedAttribs", v);
            this._extendedAttribs = v;
            clearMissingFlag(
                    schemarise.alfa.runtime.model.IDataType.IDataTypeDescriptor
        ...
        public IDataTypeBuilder setTypeDefName(java.util.Optional<java.lang.String> v) {
        ...
        public IDataTypeBuilder setTypeDefName(java.lang.String v) {
        ...
        public IDataType build() {
            ...
            if (builderConfig().getCustomBuilderFactory().isPresent())
                ...
                obj =
                        new schemarise.alfa.runtime.model.IDataType._IDataTypeConcrete(
                                _extendedAttribs, _typeDefName);
        ...
        public java.lang.String toString() {
            return com.schemarise.alfa.runtime.utils.Utils.udtToString(
                    ...
                    new java.lang.String[] {"ExtendedAttribs", "TypeDefName"},
                    new java.lang.Object[] {_extendedAttribs, _typeDefName});
        }
    }
    // </editor-fold>
    ...
    final class _IDataTypeConcrete extends _IDataType__Base__ implements IDataType {

        private _IDataTypeConcrete() {
            super();
        }
        ...
        private _IDataTypeConcrete(
            ...
            super(_extendedAttribs, _typeDefName);
        }
    }
    ...
    abstract class _IDataType__Base__ {
        ...
        public int hashCode() {
            return java.util.Objects.hash(_extendedAttribs, _typeDefName);
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof schemarise.alfa.runtime.model.IDataType._IDataTypeConcrete))
                return false;
            schemarise.alfa.runtime.model.IDataType._IDataTypeConcrete rhs =
                    (schemarise.alfa.runtime.model.IDataType._IDataTypeConcrete) o;
    ...
    public static final class IDataTypeDescriptor
            extends com.schemarise.alfa.runtime.utils.DefaultTypeDescriptor {
        public static java.lang.String TYPE_NAME = "schemarise.alfa.runtime.model.IDataType";
        public static schemarise.alfa.runtime.model.IDataType.IDataTypeDescriptor INSTANCE =
                new schemarise.alfa.runtime.model.IDataType.IDataTypeDescriptor();
        ...
        java.util.function.BiConsumer<
                        schemarise.alfa.runtime.model.IDataType._IDataTypeBuilderImpl,
                        com.schemarise.alfa.runtime.DataSupplier>
        ...
        public java.util.Optional<
                        java.util.function.BiConsumer<
                                IDataType, com.schemarise.alfa.runtime.DataConsumer>>
        ...
        @Override
        public IDataTypeBuilder builder() {
            return new schemarise.alfa.runtime.model.IDataType._IDataTypeBuilderImpl();
        }

        @Override
        public IDataTypeBuilder builder(com.schemarise.alfa.runtime.IBuilderConfig cc) {
            return new schemarise.alfa.runtime.model.IDataType._IDataTypeBuilderImpl(cc);
        }

        public IDataTypeDescriptor() {
            super.init();
        }
        ...
        protected java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<IDataType>>
                _fieldsMeta_ =
                        java.util.Collections.unmodifiableMap(
                                new java.util.LinkedHashMap() {
                                    {
        ...
        @Override
        public java.util.Map<java.lang.String, com.schemarise.alfa.runtime.FieldMeta<IDataType>>
                getAllFieldsMeta() {
            return _fieldsMeta_;
        }
        ...
        public java.util.Set<java.lang.String> getImmediateDescendants() {
            return new java.util.HashSet(
                    java.util.Arrays.asList(
                            "schemarise.alfa.runtime.model.AnyDataType",
        ...
        public java.lang.String getChecksum() {
            /*
            schemarise.alfa.runtime.model.IDataType{ExtendedAttribs:optional<map<string,string>;>;TypeDefName:optional<string;>;}
            schemarise.alfa.runtime.model.IDataType{}
            */
            return "4404d6a0:5fbc41ae";
        }
    }
    // </editor-fold>
}
