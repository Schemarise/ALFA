...
// https://github.com/AdoptOpenJDK/openjdk-jdk12u/blob/master/src/java.base/share/classes/java/util/stream/Collectors.java
...
final class Jdk12Collectors {
    ...
    public static <T, A, R, RR> Collector<T, A, RR> collectingAndThen(Collector<T, A, R> downstream,
        ...
        if (characteristics.contains(Collector.Characteristics.IDENTITY_FINISH)) {
            if (characteristics.size() == 1)
                characteristics = Jdk12Collectors.CH_NOID;
            else {
    ...
    Collector<T, ?, M> groupingBy(Function<? super T, ? extends K> classifier,
        ...
        BinaryOperator<Map<K, A>> merger = Jdk12Collectors.<K, A, Map<K, A>>mapMerger(downstream.combiner());
        @SuppressWarnings("unchecked")
    ...
    Collector<T, ?, M> groupingByConcurrent(Function<? super T, ? extends K> classifier,
        ...
        Supplier<A> downstreamSupplier = downstream.supplier();
        BiConsumer<A, ? super T> downstreamAccumulator = downstream.accumulator();
        BinaryOperator<ConcurrentMap<K, A>> merger = Jdk12Collectors.<K, A, ConcurrentMap<K, A>>mapMerger(downstream.combiner());
        @SuppressWarnings("unchecked")
    ...
    Collector<T, ?, Map<K, U>> toUnmodifiableMap(Function<? super T, ? extends K> keyMapper,
        ...
        return collectingAndThen(
                ...
                map -> (Map<K, U>) Map_ofEntries(map.entrySet().toArray(new Map.Entry[0])));
    }
        ...
        public Set<Map.Entry<Boolean, T>> entrySet() {
            return new AbstractSet<Map.Entry<Boolean, T>>() {
                ...
                public Iterator<Map.Entry<Boolean, T>> iterator() {
                    ...
                    return List_of(falseEntry, trueEntry).iterator();
                }
    ...
    private static <K, U> Map<K, U> Map_ofEntries(Map.Entry<K, U>[] array) {
        Map<K, U> ret = new HashMap<>();

        for (Map.Entry<K, U> e : array) {
    ...
    static <E> List<E> List_of(E e1, E e2) {
