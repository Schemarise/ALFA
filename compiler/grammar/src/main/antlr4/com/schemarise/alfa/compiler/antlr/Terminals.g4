...
idOnly
	: id = ( ID | INCLUDES | MAP | LIST | SCOPE | FUNC | SET | TUPLE | STREAM | NAMESPACE | RECORD | ENTITY | TRAIT | KEY | CONST | INTERNAL | FRAGMENT |
	         DOLLAR_KEY | ENUM | UNION | FIELD | EXTENSION | SERVICE | LIBRARY | METHOD | ANNOTATION | PUBLISH | CONSUME | DATAPRODUCT |
	         INCLUDE | PERIOD | IN | OUT | INOUT | EXTERNAL )
	;
...
OPTQID
	: ( ID | INCLUDES | MAP | LIST | FUNC | SET | TUPLE | STREAM | NAMESPACE | RECORD | ENTITY | TRAIT | KEY | DOLLAR_KEY | ENUM | UNION | FIELD | SERVICE | METHOD | ANNOTATION | IN | OUT | INOUT )
	    '?.'
	  ( ID | INCLUDES | MAP | LIST | FUNC | SET | TUPLE | STREAM | NAMESPACE | RECORD | ENTITY | TRAIT | KEY | DOLLAR_KEY | ENUM | UNION | FIELD | SERVICE | METHOD | ANNOTATION | IN | OUT | INOUT )
	  ( '?.'
	  ( ID | INCLUDES | MAP | LIST | FUNC | SET | TUPLE | STREAM | NAMESPACE | RECORD | ENTITY | TRAIT | KEY | DOLLAR_KEY | ENUM | UNION | FIELD | SERVICE | METHOD | ANNOTATION | IN | OUT | INOUT )
