...
class Fields(val location: IToken, val fields: Seq[Field]) extends BaseNode with ResolvableNode {

  override def nodeType: Nodes.NodeType = Nodes.FieldsNode

  override def resolvableInnerNodes() = fields
}