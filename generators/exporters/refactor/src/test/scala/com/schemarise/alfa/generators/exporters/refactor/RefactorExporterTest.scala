...
class RefactorExporterTest extends AlfaFunSuite {
  ...
  test("Common specialize selected fields test") {
    ...
    super.equalsIgnoringWhitespace(genbase1,
      """// Generated by ALFA Refactor
        |
        |trait Common.Base2 {
        |  a : int
    ...
    super.equalsIgnoringWhitespace(genbase3,
      """// Generated by ALFA Refactor
        |
        |trait Common.Base4 {
        |  x : int
    ...
    val m2 = new java.util.HashMap[String, Object]()
    ...
    super.equalsIgnoringWhitespace(genbase1a,
      """// Generated by ALFA Refactor
        |
    ...
    super.equalsIgnoringWhitespace(genbase2a,
      """// Generated by ALFA Refactor
        |
        |trait Common.Base2 {
        |  a : int
    ...
    super.equalsIgnoringWhitespace(genbase3a,
      """// Generated by ALFA Refactor
        |
        |trait Common.Base3 {
        |  z : int
    ...
    super.equalsIgnoringWhitespace(VFS.read(tgtDir2.resolve("Common.R8.alfa")),
