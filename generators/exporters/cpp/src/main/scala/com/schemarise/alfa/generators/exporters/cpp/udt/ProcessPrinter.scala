...
import com.schemarise.alfa.compiler.ast.model.ILibrary
...
class ProcessPrinter(tw: TextWriter, outputDir: Path) extends PrinterBase(tw.logger, outputDir) {
  def print(udt: ILibrary): Unit = {
